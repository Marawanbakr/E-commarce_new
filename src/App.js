...
import WoodenDesk0 from './components/components_Product/SignlePadges/WoodenDesk_0/js'
    ...
    <div className='App'>
      ...
      <BrowserRouter>
        <Routes>
          ...
          ></Route>
          <Route path='/products/Bar_Stool' element={<BarStool />}></Route>
          <Route
